...
Elm.QuoteBox = Elm.QuoteBox || {};
Elm.QuoteBox.make = function (_elm) {
   "use strict";
   _elm.QuoteBox = _elm.QuoteBox || {};
   if (_elm.QuoteBox.values)
   return _elm.QuoteBox.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var quoteBoxStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                           "background-color",
                                                           "black")
                                                           ,A2(_op["=>"],
                                                           "width",
                                                           ...
                                                           "border",
                                                           "1px solid gray")]));
   var imageBoxStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                           "width",
                                                           "80px")
                                                           ,A2(_op["=>"],
                                                           "height",
                                                           ...
                                                           "background-color",
                                                           "black")]));
   var imageStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                        "height",
                                                        "100%")
                                                        ,A2(_op["=>"],
                                                        "width",
                                                        ...
                                                        "border-radius",
                                                        "12px")]));
   var textBoxStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                          "height",
                                                          "80px")
                                                          ,A2(_op["=>"],
                                                          "background-color",
                                                          ...
                                                          "float",
                                                          "left")]));
   var closingBoxStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                             "height",
                                                             "15px")
                                                             ,A2(_op["=>"],
                                                             "width",
   ...
   model) {
      return A2($Html.div,
      _L.fromArray([quoteBoxStyle]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([imageBoxStyle]),
                   _L.fromArray([A2($Html.img,
                   _L.fromArray([imageStyle
                                ,$Html$Attributes.src(model.imageUrl)]),
                   _L.fromArray([]))]))
                   ,A2($Html.div,
                   _L.fromArray([textBoxStyle]),
                   _L.fromArray([$Html.text(model.author)
                                ,A2($Html.p,
                                _L.fromArray([]),
                                _L.fromArray([A2($Html.i,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(model.quote)]))]))]))
                   ,A2($Html.div,
                   _L.fromArray([closingBoxStyle
   ...
   model) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple0": return model;}
         _U.badCase($moduleName,
         "on line 28, column 19 to 24");
      }();
   });
   var init = F3(function (author,
   imageUrl,
   quote) {
      return {_: {}
             ,author: author
...
Elm.QuoteBoxList = Elm.QuoteBoxList || {};
Elm.QuoteBoxList.make = function (_elm) {
   "use strict";
   _elm.QuoteBoxList = _elm.QuoteBoxList || {};
   if (_elm.QuoteBoxList.values)
   ...
   var buttonStyles = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                          "width",
                                                          "100%")
                                                          ,A2(_op["=>"],
                                                          "height",
                                                          "20px")]));
   var panelStyles = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
                                                         "width",
                                                         "768px")
                                                         ,A2(_op["=>"],
                                                         "height",
